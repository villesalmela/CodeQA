...
def login(user_id: str, success: bool, remote_ip: str, reason: str=""):
    query = "INSERT INTO auth_events (uid, event_type, success, remote_ip, reason) \
...
def verification(user_id: str, success: bool, remote_ip: str):
    query = "INSERT INTO auth_events (uid, event_type, success, remote_ip) \
...
def account_creation(user_id: str, success: bool, remote_ip: str, reason: str=""):
    query = "INSERT INTO account_events (uid, event_type, success, remote_ip, reason) \
